...
-- Czas generowania: 07 Lis 2022, 23:30
...
CREATE TABLE
    `users` (
        ...
        `role` enum(
            ...
            'admin',
            ''
        ) CHARACTER SET utf8mb3 COLLATE utf8mb3_polish_ci NOT NULL DEFAULT 'user',
...
ADD
    KEY `photoId` (`photoId`),
ADD
    KEY `photos_comments_ibfk_2` (`authorId`);
...
ALTER TABLE
    `albums` MODIFY `id` int NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 30;
...
ALTER TABLE
    `photos` MODIFY `id` int NOT NULL AUTO_INCREMENT,
    AUTO_INCREMENT = 30;
...
ALTER TABLE
    `photos_comments` MODIFY `id` int NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `photos`
ADD
    CONSTRAINT `photos_ibfk_1` FOREIGN KEY (`albumId`) REFERENCES `albums` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `photos_comments`
ADD
    CONSTRAINT `photos_comments_ibfk_1` FOREIGN KEY (`photoId`) REFERENCES `photos` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
ADD
    CONSTRAINT `photos_comments_ibfk_2` FOREIGN KEY (`authorId`) REFERENCES `users` (`id`) ON DELETE
...
ALTER TABLE `photos_ratings`
ADD
    CONSTRAINT `photos_ratings_ibfk_1` FOREIGN KEY (`photoId`) REFERENCES `photos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
    CONSTRAINT `photos_ratings_ibfk_2` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
